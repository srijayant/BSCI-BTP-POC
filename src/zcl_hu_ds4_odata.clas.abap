CLASS zcl_hu_ds4_odata DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_HU_DS4_ODATA IMPLEMENTATION.


  METHOD if_rap_query_provider~select.
    DATA: ls_entity_key     TYPE zzodata_zc_rap_handl200427a3b5,
          lt_business_data  TYPE TABLE OF zzodata_zc_rap_handl200427a3b5,
          ls_business_data  TYPE zzodata_zc_rap_handl200427a3b5,
          lo_http_client    TYPE REF TO if_web_http_client,
          lo_client_proxy   TYPE REF TO /iwbep/if_cp_client_proxy,
          lo_request        TYPE REF TO /iwbep/if_cp_request_read_list,
          lo_response       TYPE REF TO /iwbep/if_cp_response_read_lst,
          lt_hu             TYPE TABLE OF zce_hu_ds4,
          ls_hu             TYPE zce_hu_ds4,
...
************************************************************************************get data from ds4
              TRY.
                  ...
                  lo_request = lo_client_proxy->create_resource_for_entity_set('ZC_RAP_HANDLINGUNIT' )->create_request_for_read( ).

                  DATA(lv_top)     = io_request->get_paging( )->get_page_size( ).
                  DATA(lv_skip)    = io_request->get_paging( )->get_offset( ).

                  DATA : lv_top_t  TYPE i,
                         lv_skip_t TYPE i.
                  lv_top_t = lv_top.
                  lv_skip_t = lv_skip.
...
************************************************************************************custom entity implementation
              ...
              WHERE handeling_unit_internal = @lt_business_data-Venum
              INTO TABLE @DATA(lt_glb_wo).


              IF lv_details_read = abap_false.
                LOOP AT lt_business_data INTO ls_business_data.
                  ls_hu = CORRESPONDING #( ls_business_data ).
                  DATA(ls_glb_wo) = VALUE #( lt_glb_wo[ handeling_unit_internal = ls_business_data-Venum ] DEFAULT space ).
                  ls_hu-WorkOrder = ls_glb_wo-work_order.
                  APPEND ls_hu TO lt_hu.
                  CLEAR ls_hu.
                ENDLOOP.
              ELSE.
                READ TABLE lt_filter_cond WITH KEY name = 'VENUM' INTO DATA(ls_productid_filter_key).
                IF sy-subrc = 0 AND lines( ls_productid_filter_key-range ) = 1.
                  ...
                  IF sy-subrc = 0 AND ls_id_option-sign = 'I' AND ls_id_option-option = 'EQ' AND ls_id_option-low IS NOT INITIAL.
                    DATA(lv_venum_key) = ls_id_option-low.
                  ENDIF.
                  ls_business_data = VALUE #( lt_business_data[ Venum = lv_venum_key ] DEFAULT space ).
                  ls_hu = CORRESPONDING #( ls_business_data ).
                  ls_glb_wo = VALUE #( lt_glb_wo[ handeling_unit_internal = ls_business_data-Venum ] DEFAULT space ).
                  ls_hu-WorkOrder = ls_glb_wo-work_order.
                  ls_hu-gwo_uuid = ls_glb_wo-gwo_uuid.
                  ls_hu-created_by = ls_glb_wo-created_by.
                  ls_hu-created_on = ls_glb_wo-created_on.
                  APPEND ls_hu TO lt_hu.
                  CLEAR ls_hu.
                ENDIF.
              ENDIF.
              ...
              io_response->set_total_number_of_records( lines( lt_hu ) ).
              io_response->set_data( lt_hu ).
            ELSE.
  ...
  METHOD is_key_filter.
    ...
    READ TABLE it_filter_cond WITH KEY name = 'VENUM' INTO DATA(ls_productid_filter_key).
    IF sy-subrc = 0 AND lines( ls_productid_filter_key-range ) = 1.
      READ TABLE ls_productid_filter_key-range INTO DATA(ls_id_option) INDEX 1.
      IF sy-subrc = 0 AND ls_id_option-sign = 'I' AND ls_id_option-option = 'EQ' AND ls_id_option-low IS NOT INITIAL.
